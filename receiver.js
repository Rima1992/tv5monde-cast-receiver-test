 ...
 *
 * Supporte 3 cas :
 *   1. HLS + Widevine (DRM Nagra)    → token nv-authorizations injecté dans les requêtes licence
...
(function () {
  ...
  playerManager.setMessageInterceptor(
    ...
    function (request) {
      ...
      try {
        ...
        // Bitmovin SDK ne met pas liveConfig pour HLS live sans DRM
        // => streamType arrive BUFFERED => Shaka échoue sur le live
  ...
  // ─── Injection Nagra dans requêtes licence Widevine ──────────────────────
